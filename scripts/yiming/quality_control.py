...
from common_paths import local_yiming_data_folder, local_yiming_deriv_folder, local_yiming_csv_path
...
def main():
    ...
    mouse = parsed_args.mice
    day = parsed_args.days

    mouse_string = f"{mouse:02d}"
    day_string = f"{day:02d}"

    protocol = parsed_args.protocols
...
def get_args():
    ...
    parser.add_argument("--mice", type=int)
    parser.add_argument("--days", type=int)
    parser.add_argument("--sessions")
    parser.add_argument("--protocols")
    parser.add_argument("--data_folder", default=local_yiming_data_folder)
    parser.add_argument("--deriv_folder", default=local_yiming_deriv_folder)
    parser.add_argument("--filepaths_csv", default=local_yiming_csv_path)
